 ...
 */
package com.e.bloctap2pay.nfc.iso7816emv;

import com.e.bloctap2pay.nfc.model.enums.CountryCodeEnum;
import com.e.bloctap2pay.nfc.model.enums.CurrencyEnum;
import com.e.bloctap2pay.nfc.model.enums.TransactionTypeEnum;
...
//			terminalQual.setReaderIsOfflineOnly(true);
			...
			val = new byte[] { (byte) 0x36, (byte) 0xA0, (byte) 0x40, (byte) 0x00};
...
//			val = BytesUtils.fromString("00");
			val = BytesUtils.fromString("000000002000");
