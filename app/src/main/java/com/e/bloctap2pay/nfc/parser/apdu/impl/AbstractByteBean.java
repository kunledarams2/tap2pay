 ...
 */
package com.e.bloctap2pay.nfc.parser.apdu.impl;

import com.e.bloctap2pay.nfc.iso7816emv.ITag;
import com.e.bloctap2pay.nfc.iso7816emv.TagAndLength;
import com.e.bloctap2pay.nfc.model.AbstractData;
import com.e.bloctap2pay.nfc.parser.apdu.IFile;
import com.e.bloctap2pay.nfc.parser.apdu.annotation.AnnotationData;
import com.e.bloctap2pay.nfc.parser.apdu.annotation.AnnotationUtils;
	...
	protected void setField(final Field field, final IFile pData, final Object pValue) {
		if (field != null) {
			try {
				...
				LOGGER.error("Parameters of field.set are not valid", e);
